var ComponentsDropdowns = function () {
    ...
    var handleSelect2Modal = function () {
        ...
        $('#select2_sample_modal_2f').select2({
            placeholder: "请选择",
            allowClear: true
        });
        
        $('#select2_sample_modal_2c').select2({
            placeholder: "请选择",
            allowClear: true
        });
        
        $('#select2_sample_modal_2j').select2({
            placeholder: "请选择",
            allowClear: true
        });
        
        $('#select2_sample_modal_2s').select2({
            placeholder: "请选择",
            allowClear: true
        });
        
        $('#select2_sample_modal_2x').select2({
            placeholder: "请选择",
            allowClear: true
        });
